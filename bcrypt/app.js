...
// - A senha informada pelo usuário é convertida em hash utilizando a mesma técnica do cadastro e comparada com a senha que já está armazenada no Banco de Dados.

import bcrypt from 'bcrypt';

const saltRounds = 10;  // Número de "camadas" de segurança
const senhaInformada = "123456";
